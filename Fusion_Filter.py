...
class Fusion(object):
    ...
    def __init__(self, read_coro):
        ...
        gyro_meas_error = radians(40)  # Original code indicates this leads to a 2 sec response time
    ...
    async def _update_nomag(self, slow_platform):
        while True:
            ...
            self.roll = degrees(atan2(2.0 * (self.q[0] * self.q[1] + self.q[2] * self.q[3]),
                                      self.q[0] * self.q[0] - self.q[1] * self.q[1] - self.q[2] * self.q[2] + self.q[
                                          3] * self.q[3]))
    ...
    async def _update_mag(self, slow_platform):
        while True:
            ...
            s1 = (
            -_2q3 * (2 * q2q4 - _2q1q3 - ax) + _2q2 * (2 * q1q2 + _2q3q4 - ay) - _2bz * q3 * (_2bx * (0.5 - q3q3 - q4q4)
                                                                                              + _2bz * (
                                                                                              q2q4 - q1q3) - mx) + (
            ...
            s2 = (
            _2q4 * (2 * q2q4 - _2q1q3 - ax) + _2q1 * (2 * q1q2 + _2q3q4 - ay) - 4 * q2 * (1 - 2 * q2q2 - 2 * q3q3 - az)
            ...
            s3 = (
            -_2q1 * (2 * q2q4 - _2q1q3 - ax) + _2q4 * (2 * q1q2 + _2q3q4 - ay) - 4 * q3 * (1 - 2 * q2q2 - 2 * q3q3 - az)
